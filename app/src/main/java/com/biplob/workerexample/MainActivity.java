...
import com.biplob.workerexample.R;
import com.biplob.workerexample.databinding.ActivityMainBinding;
		...
		mainBinding.appCompatButtonStart.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (mainBinding.appCompatButtonStart.getText().toString().equalsIgnoreCase(getString(R.string.button_text_start))) {
					...
					WorkManager.getInstance(MainActivity.this).enqueueUniquePeriodicWork("Location", ExistingPeriodicWorkPolicy.REPLACE, periodicWork);
					...
					WorkManager.getInstance(MainActivity.this).cancelAllWorkByTag(TAG);
